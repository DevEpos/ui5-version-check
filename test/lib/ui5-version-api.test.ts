...
describe("ui5-version-api.ts", () => {
  ...
  it("Test year quarter conversion", () => {
    ...
    expect(new UI5Version(semver.coerce("1.132.*")!, "Q2/2026", true, true).eocpDate).toEqual(new Date(Date.UTC(2026, 6, 0)));
    expect(new UI5Version(semver.coerce("1.132.*")!, "Q3/2026", true, true).eocpDate).toEqual(new Date(Date.UTC(2026, 9, 0)));
    expect(new UI5Version(semver.coerce("1.132.*")!, "Q4/2026", true, true).eocpDate).toEqual(new Date(Date.UTC(2026, 12, 0)));
  });
});
